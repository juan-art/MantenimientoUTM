...
$("#btn_IngresarServicio").click(function(){
 if($('#programa').val()=="" && $('#presupuesto').val()=="" && $('#descripcion').val()==""){
             var animate_in = 'lightSpeedIn',
                ...
                $('#span_mensaje_programa').html('Ingrese Programa');
...
function registrar_servicios(){    
  ...
  var datos = new FormData($("#frmIngresarServicio")[0]);
  $.ajax({
    url: "/servicio",
    ...
    success:function(res){
      if(res.registro==true){
        ...
        document.getElementById("frmIngresarServicio").reset();  
        $("#myModal_IngresarServicio").modal("hide");
        $("#datatable").load("/lista_servicio");
       }
    }
  });
}
...
// Actualizar Progrmas
            $("#btn_ActualizarServicios").click(function() {
    ...
    $.get(route,function(res){
      ...
      $("#programa_A").val(res.nombre_programa);
      });
    }
